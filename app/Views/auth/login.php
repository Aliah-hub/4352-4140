...
<div class="auth-page">
  <div class="auth-card">
    ...
    <p class="auth-subtitle">Systeme Mobile Money</p>
    ...
    <div class="auth-tabs">
      ...
      <button class="tab-btn" id="tab-operateur" onclick="showTab('operateur')">
        <i class="bi bi-shield-lock"></i> Operateur
      </button>
    </div>
    ...
    <div id="form-client">
      <form action="<?= base_url('login/client') ?>" method="post">
        ...
        <div class="form-group">
          ...
          <small>Votre compte est cree automatiquement à la 1ere connexion.</small>
        </div>
    ...
    <div id="form-operateur" class="d-none">
      <form action="<?= base_url('login/operateur') ?>" method="post" id="form-op">
        ...
        <p style="color: var(--muted); text-align: center; margin-bottom: 20px;">Acces direct pour l'administrateur</p>

        <button type="submit" class="btn-primary-custom" style="width: 100%;">Acceder au tableau de bord</button>
      </form>
    </div>
  </div>
</div>
